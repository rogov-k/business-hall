        ...
        <div class="content--head__wrapper">
            <div class="header-content">
                ...
                <div class="header-item items--menu">
                    <div class="item-menu"><a href="#welcome">Главная</a></div>
                    <div class="item-menu"><a href="#main">Номера</a></div>
                    <div class="item-menu"><a href="#rules">Правила</a></div>
                    <div class="item-menu"><a href="#form">Контакты</a></div>
                    <div class="item-menu"><a href="#comments">Отзывы</a></div>
                </div>
            </div>
        </div>
    </div>
